...
namespace CGTEST {
    ...
    static void compareStatus(gu_odometry_status expected, gu_odometry_status actual) {
        gu_cartesian_coordinate *expectedCoord = (gu_cartesian_coordinate*)expected.tracked_coordinate;
        gu_cartesian_coordinate *actualCoord = (gu_cartesian_coordinate*)actual.tracked_coordinate;
    ...
    TEST_F(TrackingTests, TrackWithReset) {
        ...
        gu_cartesian_coordinate coord = {77, 150};
        gu_odometry_status currentStatus = {100, 20, deg_d_to_rad_d(d_to_deg_d(10.0)), &coord};
        gu_cartesian_coordinate expectedCoord = {70, 100};
